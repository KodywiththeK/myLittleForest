...
export default function HomeCommitSection() {
  return (
    <div className="relative flex min-h-[280px] w-full min-w-[100vw] flex-col">
      <div className="absolute inset-4 flex flex-col justify-between rounded-2xl bg-midNavy p-8 text-white">
